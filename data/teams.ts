...
export const teams: Team[] = [
  ...
  },
  {
    ...
    players: [
      { name: "Maxime Dubois", number: 1, position: "Gardien" },
      { name: "Elio Hardouin", number: 5, position: "Défenseur central" },
      { name: "Thomas Leroy", number: 2, position: "Latéral droit" },
      { name: "Bastien Roy", number: 3, position: "Latéral gauche" },
      { name: "Yanis Lopez", number: 6, position: "Milieu défensif" },
      { name: "Romain Carré", number: 10, position: "Meneur de jeu" },
      { name: "Lucas Henry", number: 8, position: "Milieu" },
      { name: "Julien Bernard", number: 11, position: "Ailier" },
      { name: "Mehdi Aziz", number: 7, position: "Ailier" },
      { name: "Kévin Martin", number: 9, position: "Avant-centre" },
      { name: "Florian Petit", number: 14, position: "Attaquant" },
    ],
  },
  {
    slug: "veterans",
